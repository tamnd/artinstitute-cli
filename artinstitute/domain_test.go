...
// HTTP behaviour is covered in artinstitute_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "artinstitute://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("artinstitute", "about")
	if err != nil || got.String() != "artinstitute://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want artinstitute://page/about", got.String(), err)
	}
}
