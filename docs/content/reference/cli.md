...
```
artinstitute <command> [arguments] [flags]
```

Run `artinstitute <command> --help` for the full flag list on any command. This
...
per operation you declare in `artinstitute/domain.go`.
